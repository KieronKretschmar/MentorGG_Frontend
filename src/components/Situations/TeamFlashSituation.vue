      ...
      <div class="body" v-if="isVisible">
        ...
        <div class="row">
          <div class="l">
            ...
            <div class="col centered">Teammates flashed</div>
            <div class="col centered">Total time flashed</div>
        ...
        <div v-for="(situation, index) in situationCollection.Situations" :key="index" class="row">
          <div class="l">
            ...
            <div class="col centered">{{situation.TeammatesFlashed}}</div>
            <div class="col centered">{{situation.TimeFlashed}} ms</div>
            <div class="col centered">{{situation.DiedBlindCount}}</div>
          </div>
          <div class="r">
