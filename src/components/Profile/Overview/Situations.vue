...
export default {
  ...
  computed: {
    ...
    chartDataPoints() {
      ...
      ret.Misplays = [0.76, 0.73, 0.77, 0.68, 0.63, 0.31, 0.31, 0.51, 0.43, 0.32, 0.33, 0.17, 0.22, 0.11, 0.08, 0.07];
      ret.Highlights = [0.02, 0.13, 0.08, 0.23, 0.26, 0.34, 0.87, 0.56, 0.53, 0.53, 0.71, 0.77, 0.89, 0.56, 0.79, 0.91];
